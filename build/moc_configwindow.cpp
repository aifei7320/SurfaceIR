...
#include "../showframe/configwindow/configwindow.h"
...
QT_MOC_LITERAL(1, 13, 7), // "Conform"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 21) // "on_phbConform_clicked"

    },
    "ConfigWindow\0Conform\0\0on_phbConform_clicked"
};
...
void ConfigWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Conform((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_phbConform_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (ConfigWindow::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConfigWindow::Conform)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConfigWindow::Conform(QString _t1)
{
