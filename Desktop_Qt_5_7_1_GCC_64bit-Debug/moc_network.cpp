...
#include "../showframe/network/network.h"
...
QT_MOC_LITERAL(5, 39, 18) // "connectEstablished"

    },
    "NetworkThread\0sendFrame\0\0QImage&\0image\0"
    "connectEstablished"
};
...
void NetworkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->connectEstablished(); break;
        default: ;
        }
        ...
        {
            typedef void (NetworkThread::*_t)(QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkThread::sendFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetworkThread::sendFrame(QImage & _t1)
{
